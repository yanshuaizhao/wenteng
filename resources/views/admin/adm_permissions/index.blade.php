            ...
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="col-md-2 text-right">
                        <a href="/admin/adm_permissions/create" class="btn btn-success btn-md">
    ...
    <script>
        $(function () {
            var table = $("#admin-users-list").DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '/admin/adm_permissions/index',
                    type: 'POST',
                    headers: {
                ...
                columnDefs: [
                    {
                        'targets': -1, "render": function (data, type, row) {
                            ...
                            //编辑
                            if (row_edit) {
                                str += '<a style="margin:3px;" href="/admin/adm_permissions/' + row['id'] +'/edit" class="X-Small btn-xs text-success "><i class="fa fa-edit"></i> 编辑</a>';
                            }
            ...
            $("table").delegate('.del_item', 'click', function () {
                ...
                $('.deleteForm').attr('action', '/admin/adm_permissions/' + id);
                $("#modal-delete").modal();
            });
