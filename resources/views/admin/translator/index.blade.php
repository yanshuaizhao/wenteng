            ...
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="col-md-2 text-right">
                        <a href="/admin/translator/create" class="btn btn-success btn-md">
                            <i class="fa fa-plus-circle"></i> 添加译者
                        </a>
                    </div>
    ...
    <script>
        $(function () {
                ...
                columnDefs: [
                    {
                        ...
                        "render": function (data, type, row) {
                            ...
                            //编辑
                            if (row_edit) {
                                str += '<a style="margin:3px;" href="/admin/translator/' + row['id'] +'/edit" class="X-Small btn-xs text-success "><i class="fa fa-edit"></i> 编辑</a>';
                            }
            ...
            $("table").delegate('.del_item', 'click', function () {
                ...
                $('.deleteForm').attr('action', '/admin/translator/' + id);
                $("#modal-delete").modal();
            });
